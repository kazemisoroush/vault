...
func suppressNag(stack awscdk.Stack, healthRoute constructs.IConstruct) {
	cdknag.NagSuppressions_AddStackSuppressions(stack, &[]*cdknag.NagPackSuppression{
		...
		},
		{
			...
			Reason: jsii.String("S3 and DynamoDB access uses object- and item-level wildcards generated by the CDK grant helpers, scoped to the single Vault bucket and table."),
		},
		{
